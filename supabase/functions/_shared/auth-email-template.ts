/** Templates de e-mail transacionais Always On — convite, recovery, acesso existente. */
...
> = {
  convite: {
    ...
    introHtml: (nome) =>
      nome
        ? `Você foi convidado para a plataforma de gestão <strong style="color:${NAVY};font-weight:600">Always On</strong>.`
        : `Você foi convidado para a plataforma de gestão <strong style="color:${NAVY};font-weight:600">Always On</strong>.`,
    introText: () => 'Você foi convidado para a plataforma de gestão Always On.',
  },
  recuperar_senha: {
    eyebrow: 'Recuperar acesso',
    subject: 'Redefina sua senha — Always On',
    button: 'Definir nova senha',
    introHtml: () =>
      `Recebemos um pedido para redefinir a senha da sua conta na plataforma <strong style="color:${NAVY};font-weight:600">Always On</strong>. Se não foi você, ignore este e-mail.`,
    introText: () =>
      'Recebemos um pedido para redefinir a senha da sua conta na plataforma Always On. Se não foi você, ignore este e-mail.',
  },
  acesso_existente: {
    eyebrow: 'Acesso',
    subject: 'Continue seu acesso — Always On',
    button: 'Continuar na plataforma',
    introHtml: () =>
      `Há um convite pendente para a sua conta na plataforma <strong style="color:${NAVY};font-weight:600">Always On</strong>. Use o link abaixo para continuar.`,
    introText: () => 'Há um convite pendente para a sua conta na plataforma Always On.',
  },
}
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="padding:32px 36px 0">
              <p style="margin:0 0 14px;font-size:22px;font-weight:600;color:${NAVY};letter-spacing:-0.02em;font-family:Georgia,serif">${escapeHtml(saudacao)}</p>
          ...
          <tr>
            <td style="padding:0 36px 28px">
              <p style="margin:0;font-size:12px;line-height:1.65;color:${MUTED}">
                ...
                <a href="${content.actionLink}" style="color:${NAVY};word-break:break-all">${content.actionLink}</a>
              </p>
