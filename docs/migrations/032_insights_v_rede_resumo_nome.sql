-- Coluna nome_rede em resumo de rede: manual = nome cadastrado; raiz = nome/razão nas NFs (MAX).
...
COMMENT ON VIEW alwayson_insights_v_rede_resumo IS
  'Sell-out por rede; nome_rede (raiz) prioriza razão social nas NFs; manual = nome admin.';
